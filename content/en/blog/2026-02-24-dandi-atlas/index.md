---
title: "Introducing DANDI Atlas: Explore the DANDI Archive in 3D"
author: Ben Dichter
description: >
    DANDI Atlas is an interactive 3D brain viewer that maps DANDI Archive datasets
...
introduce [DANDI Atlas](https://dandi.github.io/dandi-atlas/)---an interactive 3D
...
DANDI Atlas is a browser-based tool that renders an interactive 3D mouse brain and
...
**3D electrode visualization.** For electrophysiology datasets, DANDI Atlas extracts
...
DANDI Atlas bridges two major neuroscience resources. Brain anatomy comes from the
...
DANDI Atlas is open source and runs entirely in your browser---no installation required.

**[Launch DANDI Atlas](https://dandi.github.io/dandi-atlas/)**

The source code is available on
[GitHub](https://github.com/dandi/dandi-atlas). Contributions, bug reports, and feature
requests are welcome.

DANDI Atlas was developed by [CatalystNeuro](https://catalystneuro.com) with support
